    ...
    if (lastUrl === "followers" || lastUrl === "following") {
            ...
            <div className="px-0 md:px-0 py-3">
              <ul className="flex items-center justify-around md:justify-center space-x-12 uppercase tracking-widest font-semibold  text-gray-600 border-b">
                <li
                  className={` ${
                    lastUrl === "followers"
                      ? "md:border-b-4 md:border-blue-400 md:-mt-px md:text-gray-700"
                      : ""
                  } `}
                >
                  <NavLink
                    className={({ isActive }) =>
                      isActive
                        ? "inline-block p-3 text-blue-400 font-bold"
                        : "inline-block p-3"
                    }
                    to="followers"
                  >
      ...
      return (
        <main className="md:mt-10 bg-gray-100 bg-opacity-25">
          ...
          {/* <div className="lg:w-8/12 md:pt-10 lg:mx-auto mb-4 md:mb-8">
            <header className="flex flex-wrap items-center p-4 md:py-8 ">
              <div className="w-3/12 md:w-4/12 md:ml-16">
                <img
              ...
              <div class="text-sm leading-normal text-gray-600 flex justify-center items-center">
