            ...
            <div className=" w-full">
              ...
              <div className="relative">
                ...
                <input
                  type="text"
                  readOnly
                  className="cursor-pointer w-full pl-4 pr-10 py-3 border leading-none rounded-lg shadow-sm focus:outline-none focus:shadow-outline text-gray-600 font-medium"
                ...
                {showDatepicker && (
                  <div
                    className="bg-white mt-12 rounded-lg shadow p-4 absolute top-0 left-0 w-full"
                    // style={{ width: "17rem" }}
                  >
                          ...
                          {dayCount.map((d, i) => (
                            ...
                            >
                              <div
                                ...
                                className={`p-2 cursor-pointer text-center font-semibold text-sm leading-none rounded-full leading-loose transition ease-in-out duration-100 ${
                                  isToday(d)
