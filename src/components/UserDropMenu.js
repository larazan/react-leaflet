...
function UserDropMenu() {
  ...
  return (
    <div className="relative inline-flex">
      ...
      <Transition
        className="origin-top-right z-10 absolute top-full right-0 min-w-54 bg-white border border-slate-200 py-1.5 rounded shadow-lg overflow-hidden mt-1"
        show={dropdownOpen}
      ...
      >
        <div
          ...
          className={`w-48 sm:w-60 md:w-56 z-20 font-normal bg-white overflow-hidden `}
        >
          ...
          <ul className="flex-col font-sans items-center justify-center text-sm">
                ...
                <Link to="post" onClick={() => setDropdownOpen(!dropdownOpen)}>
                  <li className="py-1 md:py-2 px-2 hover:bg-gray-200">
                    <div className="flex items-center space-x-2">
                      <svg
                        xmlns="http://www.w3.org/2000/svg"
