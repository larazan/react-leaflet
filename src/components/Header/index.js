...
const Header = () => {
  ...
  return (
    <>
      <header className="z-20 md:z-20 h-10 md:h-14 w-full absolute md:absolute top-0 md:m-0 px-4 md:px-5 py-6 md:py-3 flex items-center justify-between bg-white border-b shadow">
